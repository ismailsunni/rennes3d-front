import { aw as defineComponent, aL as computed, az as openBlock, aA as createElementBlock, aM as normalizeClass, aD as createBaseVNode, aO as renderSlot, aE as createVNode } from "./vendor.95126233.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    expose();
    const props = __props;
    const __returned__ = { props, IconArrow };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
const _hoisted_1 = { class: "flex pt-0 pr-0 pb-1 pl-0 gap-1 items-center grow-0" };
const _hoisted_2 = { class: "font-dm-sans text-base font-semibold" };
