import { aw as defineComponent, aL as computed, az as openBlock, aA as createElementBlock, aM as normalizeClass, aD as createBaseVNode, aE as createVNode, aJ as toDisplayString, aG as createCommentVNode } from "./vendor.95126233.js";
import { g as getColor, I as IconLine } from "./IconLine.c163f8a7.js";
...
const _hoisted_6 = { class: "flex flex-col items-start p-0 gap-1 grow" };
const _hoisted_7 = { class: "flex flex-col justify-center items-start p-0 gap-1.5" };
const _hoisted_8 = { class: "font-medium text-sm leading-5" };
const _hoisted_9 = { class: "font-medium text-sm leading-5" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", {
    class: normalizeClass(["flex items-center px-3 py-0 gap-2.5 rounded font-dm-sans", $setup.containerStyle])
  }, [
    ...
    createBaseVNode("div", _hoisted_6, [
      createBaseVNode("div", _hoisted_7, [
        createBaseVNode("div", _hoisted_8, toDisplayString($setup.props.startStation), 1),
        createBaseVNode("div", _hoisted_9, toDisplayString($setup.props.endStation), 1)
      ])
    ]),
